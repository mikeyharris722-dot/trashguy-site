        ...
        try {
          ...
          updateState(activeType, {
            followAge: followData?.ok
              ? followData.followAge || ""
              : followData?.error || "Unknown",
          });
        } catch {
          updateState(activeType, {
            followAge: "Unknown",
  ...
  return (
    <div className="w-full min-w-0 max-w-full overflow-x-hidden">
            ...
            <button
              ...
              className={`min-w-0 rounded-lg border px-1 py-2 text-[9px] font-black uppercase leading-tight tracking-[0.03em] transition sm:px-2 sm:text-xs sm:tracking-[0.07em] ${
                active
                  ...
                  : "border-purple-300/10 bg-white/[0.025] text-white/55 hover:border-purple-300/20 hover:bg-purple-500/[0.05] hover:text-white/75"
              }`}
            >
      ...
      <div className="mt-2 grid w-full min-w-0 max-w-full gap-2.5 sm:mt-3 sm:gap-3">
        ...
        <div className="relative w-full min-w-0 max-w-full overflow-hidden rounded-xl border border-purple-300/30 bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.16),rgba(88,28,135,0.08)_35%,rgba(0,0,0,0.94)_75%)] p-2.5 shadow-[0_0_28px_rgba(168,85,247,0.10),inset_0_0_30px_rgba(168,85,247,0.035)] sm:p-4">
          <div className="pointer-events-none absolute inset-x-[18%] -top-16 h-28 rounded-full bg-purple-500/10 blur-3xl" />

          <div className="relative z-10 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div className="min-w-0 flex-1">
              <div className="text-[10px] font-black uppercase tracking-[0.18em] text-purple-300/75">
                Current Winner
              </div>
              ...
              {state.winnerUsername && (
                <div className="mt-2 flex flex-wrap gap-1.5">
                  <span className="rounded-full border border-purple-300/15 bg-purple-400/[0.07] px-2 py-1 text-[9px] font-black text-purple-100">
                    {isWinnerVip
                      ? "👑 VIP"
                      : isWinnerOnCode
                        ? "💎 Code"
                  ...
                  {isWinnerDiscord && (
                    <span className="rounded-full border border-indigo-300/20 bg-indigo-400/10 px-2 py-1 text-[9px] font-black text-indigo-200">
                      💬 Discord
                    </span>
                  )}
                  ...
                  {state.followAge && (
                    <span className="rounded-full border border-purple-300/20 bg-purple-400/10 px-2 py-1 text-[9px] font-black text-purple-200">
                      {state.followAge}
                    </span>
                  )}
                </div>
            ...
            <div className="w-full rounded-xl border border-green-300/20 bg-green-400/10 px-3 py-2 text-center shadow-[0_0_14px_rgba(74,222,128,0.06)] sm:w-auto sm:min-w-[100px]">
          ...
          <div className="relative z-10 mt-3 rounded-xl border border-purple-300/12 bg-black/45 p-3">
            <div className="text-[10px] uppercase tracking-[0.18em] text-purple-200/45">
              Winner Chat
            </div>
          ...
          <div className="relative z-10 mt-3 grid gap-2 sm:grid-cols-[1fr_auto] sm:items-end">
            <label className="block min-w-0">
              <span className="text-[10px] uppercase tracking-[0.18em] text-purple-200/50">
                Award Prize $
              </span>
        ...
        <div className="min-w-0 overflow-hidden rounded-xl border border-purple-300/15 bg-black/45 shadow-[0_0_18px_rgba(168,85,247,0.04)]">
          <div className="flex items-center justify-between border-b border-purple-300/10 px-3 py-2">
            <div className="text-[10px] font-black uppercase tracking-[0.16em] text-purple-100/65">
              Live Entries
            </div>

            <div className="rounded-full border border-purple-300/25 bg-purple-400/10 px-2 py-0.5 text-[9px] font-black text-purple-200">
            ...
            <div
              className={
                state.entries.length > 10
                  ? "max-h-[340px] divide-y divide-purple-300/[0.06] overflow-y-auto"
